...
function PostJobs() {
  ...
  const submitJob = useCallback(async () => {
    ...
    const dlISO = !jobDetails.deadline
      ? null
      : new Date(jobDetails.deadline).toISOString();
    const compISO = !jobDetails.completion
      ? null
      : new Date(jobDetails.completion).toISOString();
          ...
          <div className="flex flex-1 px-6 gap-6 ">
            <div className="w-full lg:w-[60%] space-y-6">
              ...
              <div className="w-full backdrop-blur-sm flex-col flex space-y-5 rounded-lg p-6 mb-6 border border-[#14a19f]/20">
                <h2
                  style={orbitronStyle}
                  className="text-white text-xl font-bold mb-4 tracking-wide"
                >
                  Basics
                </h2>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    <p>
                      Provide details. Better clarity attracts better talent.
                    </p>
                    <span>
                      {jobDetails.jobDescription.length}/{DESCRIPTION_MAX}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="sticky top-6">
                <div className="backdrop-blur-lg flex flex-col  border border-[#14a19f]/20 rounded-xl p-6 shadow-xl text-white space-y-6">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    {PreviewJobDetails.jobDescription ||
                  ...
                  {PreviewJobDetails.budget && (
                    <div className="text-lg font-bold text-[#14a19f]">
                      Budget:{" "}
                      <span className="text-white">${jobDetails.budget}</span>
                    </div>
                  )}
                  ...
                  <div className="flex gap-4 mt-4">
                    <button
                      ...
                      disabled={
                        enhancing || applying || submiting || cancelling
                      }
                    >
                      {enhancing ? (
